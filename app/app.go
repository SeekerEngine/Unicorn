...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		unicornmoduletypes.StoreKey, wasmtypes.StoreKey, ibcfeetypes.StoreKey,
	...
	*/
	...
	app.UnicornKeeper = *unicornmodulekeeper.NewKeeper(
		appCodec,
		keys[unicornmoduletypes.StoreKey],
		keys[unicornmoduletypes.MemStoreKey],
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(unicornmoduletypes.ModuleName)
